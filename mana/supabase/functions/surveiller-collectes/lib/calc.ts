...
import type { Saisie } from '../types.ts'
...
/**
 * Base (€, coût de revient) d'une ligne enregistrée. Lignes récentes : la valeur
 * des pesées est figée à l'enregistrement selon le profil du bordereau ; anciennes
 * lignes : kg F&L × coût/kg.
 */
