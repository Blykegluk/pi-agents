...
export const FAQ: EntreeFAQ[] = [
  ...
  },
  {
    ...
    reponse:
      'Dans l’onglet Saisie, placez-vous sur la semaine concernée (une semaine passée), puis cliquez « Une association a refusé des produits ? Enregistrer une correction ». Saisissez les montants en négatif avec le justificatif du refus : le cumul, le plafond et la prochaine facture se recalculent automatiquement.',
